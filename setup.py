...
setup(
  name = 'Bufferx',         # How you named your package folder (MyLib)
  packages = ['Bufferx'],   # Chose the same as "name"
  version = '1.1.1',      # Start with a small number and increase it with every change you make
  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'Controll Your Data in Terminal ',   # Give a short description about your library
